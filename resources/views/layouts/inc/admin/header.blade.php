<header id="header" class="header fixed-top d-flex align-items-center">
    <div class="d-flex align-items-center justify-content-between"> <a href="#"
            class="logo d-flex align-items-center"><span class="d-none d-lg-block">HelloCooking</span> </a> <i
        ...
        <ul class="d-flex align-items-center">
            ...
            <li class="nav-item dropdown pe-3">
                <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                    <img src="{{ asset('admin/assets/img/noImageUser.jpg') }}" alt="Profile" class="rounded-circle"
                        width="25px" height="auto" style="aspect-ratio: 1/1;border: 1px solid gray;">
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                    ...
                    <li>
                        ...
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('logout') }}"
                            ...
                            <i class="bi bi-box-arrow-right"></i><span>{{ __('Logout') }}</span>
                        </a>
